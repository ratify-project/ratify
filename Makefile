...
e2e-notation-setup:
	...
	mkdir tsa
	curl -L https://github.com/notaryproject/notation/raw/a034721a7e3088250bbb04c5fccedbfca966d49e/internal/testdata/tsaRootCA.cer --output ${GITHUB_WORKSPACE}/.staging/tsa/tsaRootCA.cer
	
	NOTATION_EXPERIMENTAL=1 .staging/notation/notation cert add --type tsa --store certs ${GITHUB_WORKSPACE}/.staging/tsa/tsaRootCA.cer
