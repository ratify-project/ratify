...
@test "licensechecker test" {
    ...
    sleep 5
    run kubectl run licensechecker --namespace default --image=registry:5000/licensechecker:v0
    assert_failure
    ...
    sleep 15
    run kubectl run licensechecker2 --namespace default --image=registry:5000/licensechecker:v0
    assert_success
}
