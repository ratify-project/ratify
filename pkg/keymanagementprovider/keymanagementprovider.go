...
func SetCertificatesInMap(certificatesMap *sync.Map, resource string, certs map[KMPMapKey][]*x509.Certificate) {
...
func GetCertificatesFromMap(certificatesMap *sync.Map, resource string) map[KMPMapKey][]*x509.Certificate {
...
// it is concurrency-safe
func DeleteCertificatesFromMap(certificatesMap *sync.Map, resource string) {
