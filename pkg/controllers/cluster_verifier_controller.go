...
// ClusterVerifierReconciler reconciles a ClusterVerifier object
type ClusterVerifierReconciler struct {
	client.Client
	Scheme *runtime.Scheme
}

var (
	// a map to track of active cluster verifiers
	ClusterVerifierMap = map[string]vr.ReferenceVerifier{}
)
