...
// Convert_v1alpha1_Policy_To_unversioned_Policy is an autogenerated conversion function.
func Convert_v1alpha1_Policy_To_unversioned_Policy(in *Policy, out *unversioned.Policy, s conversion.Scope) error {
	return autoConvert_v1alpha1_Policy_To_unversioned_Policy(in, out, s)
}
...
// Convert_unversioned_Policy_To_v1alpha1_Policy is an autogenerated conversion function.
func Convert_unversioned_Policy_To_v1alpha1_Policy(in *unversioned.Policy, out *Policy, s conversion.Scope) error {
	return autoConvert_unversioned_Policy_To_v1alpha1_Policy(in, out, s)
}
...
// Convert_unversioned_PolicySpec_To_v1alpha1_PolicySpec is an autogenerated conversion function.
func Convert_unversioned_PolicySpec_To_v1alpha1_PolicySpec(in *unversioned.PolicySpec, out *PolicySpec, s conversion.Scope) error {
	return autoConvert_unversioned_PolicySpec_To_v1alpha1_PolicySpec(in, out, s)
}
...
// Convert_unversioned_PolicyStatus_To_v1alpha1_PolicyStatus is an autogenerated conversion function.
func Convert_unversioned_PolicyStatus_To_v1alpha1_PolicyStatus(in *unversioned.PolicyStatus, out *PolicyStatus, s conversion.Scope) error {
	return autoConvert_unversioned_PolicyStatus_To_v1alpha1_PolicyStatus(in, out, s)
}
